...
def create_model(n_fft, width):
    ...
    flattened_fft = keras.layers.TimeDistributed(keras.layers.Flatten())(max1_fft)
    flattened_gyro = keras.layers.TimeDistributed(keras.layers.Flatten())(max1_gyro)
    flattened_lin_accel = keras.layers.TimeDistributed(keras.layers.Flatten())(max1_lin_accel)
    ...
    dense1 = keras.layers.Dense(int(width * 20), activation=tf.nn.relu)(flattened_sequence)
