...
def create_model(n_fft, width):
    ...
    flattened_fft = keras.layers.TimeDistributed(keras.layers.Flatten())(max2_fft)
    flattened_gyro = keras.layers.TimeDistributed(keras.layers.Flatten())(max2_gyro)
    flattened_lin_accel = keras.layers.TimeDistributed(keras.layers.Flatten())(max2_lin_accel)
